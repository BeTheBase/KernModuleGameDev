...
public class UIManager : MonoBehaviour
{
    ...
    public Color AllTextColor => allTextColor;

    [SerializeField] private Color[] levelSelectButtonColors = new Color[2];
    public Color[] LevelSelectButtonColors { get => levelSelectButtonColors; set => levelSelectButtonColors = value; }

    [SerializeField] private List<Button> levelSelectButtons = new List<Button>();
    public List<Button> LevelSelectButtons => levelSelectButtons;
