...
public class LevelManager : GenericSingleton<LevelManager, ILevel>, ILevel
{
    ...
    private void NextLevel(Level level)
    {
        ...
        EventManager.Broadcast(EVENT.initializeGame);
        EventManagerGen<float>.BroadCast(EVENT.gameUpdateEvent, level.NextLevelPosition.x);
    }
    ...
    public void ResetPlayerPositions()
    {
        ...
        EventManagerGen<float>.BroadCast(EVENT.reloadGame, _level.CurrentLevelPostion.x);
    }
